...
class GazeboBridge(Node):
    def __init__(self):
        ...
        self.bridge_process = subprocess.Popen([
            ...
            '/world/empty/model/RocketF2/link/Body/sensor/imu_sensor/imu@sensor_msgs/msg/Imu@gz.msgs.IMU',
            '/world/empty/model/RocketF2/link/Body/sensor/magnetometer_sensor/magnetometer@sensor_msgs/msg/MagneticField@gz.msgs.Magnetometer',
            '/world/empty/model/RocketF2/link/Body/sensor/air_pressure/air_pressure@sensor_msgs/msg/FluidPressure@gz.msgs.FluidPressure',
        ...
        # SUBSCRIBERS
        self.create_subscription(Imu, 'world/empty/model/RocketF2/link/Body/sensor/imu_sensor/imu', self.imu_callback, 10)
        self.create_subscription(MagneticField, 'world/empty/model/RocketF2/link/Body/sensor/magnetometer_sensor/magnetometer', self.magnetometer_callback, 10)
        self.create_subscription(FluidPressure, 'world/empty/model/RocketF2/link/Body/sensor/air_pressure/air_pressure', self.air_pressure_callback, 10)
    ...
    def thrust_calculation(self):
        ...
        thrust_value = round((1* self.thrust_function(current_time)), 2)
